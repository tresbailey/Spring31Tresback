 ...
 * @author rbailey
 */
public class TBConsumerDetailsService implements ConsumerDetailsService, UserDetailsService {
    
    
    private static final Logger log = LoggerFactory.getLogger(TBConsumerDetailsService.class);
